        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="entry2 mb-5">
                    <a href="<?php echo base_url('singlePage/12') ?>"><img src="<?php echo base_url('public/assets/') ?>images/img_1.jpg" alt="Image" class="img-fluid rounded"></a>
            ...
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="entry2 mb-5">
                    <a href="single.html"><img src="<?php echo base_url('public/assets/') ?>images/img_2.jpg" alt="Image" class="img-fluid rounded"></a>
            ...
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <div class="entry2 mb-5">
                    <a href="single.html"><img src="<?php echo base_url('public/assets/') ?>images/img_3.jpg" alt="Image" class="img-fluid rounded"></a>
